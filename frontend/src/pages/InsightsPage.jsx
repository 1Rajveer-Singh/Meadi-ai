...
import {
  ...
  FlaskConical, Clipboard, MessageSquare, Bell, Gauge,
  Timer, Crosshair, Map, Grid, Sliders, Layers, Palette,
  AlertTriangle
} from 'lucide-react';
...
const InsightsPage = () => {
  ...
  const tabs = [
    {
      ...
      color: 'blue',
      features: ['Live Dashboards', 'KPI Monitoring', 'Trend Analysis', 'Alerts']
    },
    {
      id: 'ai-insights',
      ...
      color: 'purple',
      features: ['Predictive Models', 'Pattern Recognition', 'Risk Scoring', 'Recommendations']
    },
    {
      id: 'clinical-reports',
      ...
      color: 'green',
      features: ['Outcome Analysis', 'Quality Metrics', 'Benchmarking', 'Research Data']
    },
    {
      ...
      color: 'orange',
      features: ['Demographics', 'Epidemiology', 'Risk Stratification', 'Public Health']
    },
    {
      id: 'research-hub',
      label: 'Research Hub',
      ...
      color: 'indigo',
      features: ['Clinical Trials', 'Evidence Generation', 'Biomarkers', 'Publications']
    }
  ];
  ...
  const analyticsData = {
    performance: [
      { month: 'Jan', accuracy: 96.2, speed: 1.8, volume: 1245, satisfaction: 94 },
      { month: 'Feb', accuracy: 96.8, speed: 1.6, volume: 1387, satisfaction: 95 },
      { month: 'Mar', accuracy: 97.1, speed: 1.5, volume: 1456, satisfaction: 96 },
      { month: 'Apr', accuracy: 97.4, speed: 1.4, volume: 1523, satisfaction: 96 },
      { month: 'May', accuracy: 97.7, speed: 1.3, volume: 1698, satisfaction: 97 },
      { month: 'Jun', accuracy: 98.1, speed: 1.2, volume: 1834, satisfaction: 97 }
    ],
    diagnosticTypes: [
      { name: 'Radiology', value: 45, cases: 2341, accuracy: 98.2, color: '#3B82F6' },
      { name: 'Pathology', value: 25, cases: 1289, accuracy: 97.8, color: '#10B981' },
      { name: 'Cardiology', value: 15, cases: 743, accuracy: 96.9, color: '#F59E0B' },
      { name: 'Neurology', value: 10, cases: 456, accuracy: 97.1, color: '#8B5CF6' },
      { name: 'Others', value: 5, cases: 234, accuracy: 95.8, color: '#EF4444' }
    ],
    aiModels: [
      { name: 'Vision Transformer', accuracy: 98.5, speed: 1.2, confidence: 96 },
        ...
        {kpiMetrics.map((metric, index) => {
          ...
          return (
            <motion.div
              ...
              className="bg-white/80 backdrop-blur-xl rounded-2xl p-6 border border-white/20 shadow-xl"
            >
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        >
          <h3 className="text-xl font-bold text-gray-900 mb-6 flex items-center">
            <PieChartIcon className="w-6 h-6 mr-3 text-purple-600" />
          ...
          <div className="grid grid-cols-2 gap-2 mt-4">
            {analyticsData.diagnosticTypes.map((type, index) => (
              <div key={index} className="flex items-center space-x-2 text-sm">
                ...
                <span className="font-medium text-gray-900">{type.cases}</span>
              </div>
            ))}
          </div>
        </motion.div>
            ...
            {analyticsData.aiModels.map((model, index) => (
              <div key={index} className="p-4 bg-gradient-to-r from-gray-50 to-indigo-50 rounded-xl">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-sm font-medium text-indigo-600">{model.accuracy}%</span>
                </div>
                
                <div className="grid grid-cols-3 gap-4 text-sm">
                  <div>
                    <p className="text-gray-500">Speed</p>
                    <p className="font-medium text-gray-900">{model.speed}min</p>
                  </div>
                  <div>
      ...
      <div className="bg-white/80 backdrop-blur-xl rounded-3xl border border-white/20 shadow-2xl p-8">
        ...
        <div className="grid gap-6">
          ...
          <div className="p-6 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-2xl border border-purple-200">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-white/60 p-4 rounded-xl">
                <h4 className="font-medium text-gray-900 mb-2">Risk Predictions</h4>
                <ul className="space-y-2 text-sm text-gray-700">
                  <li className="flex items-center space-x-2">
                    <div className="w-2 h-2 bg-red-500 rounded-full"></div>
                    <span>15% increase in cardiac cases expected next month</span>
                  </li>
                  <li className="flex items-center space-x-2">
          ...
          <div className="p-6 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl border border-blue-200">
            ...
            <div className="space-y-4">
              <div className="bg-white/60 p-4 rounded-xl">
                <h4 className="font-medium text-gray-900 mb-2">Diagnostic Patterns</h4>
                <div className="flex items-center space-x-4">
                  <div className="flex-1 bg-gray-200 rounded-full h-3">
                    <div className="bg-blue-600 h-3 rounded-full" style={{ width: '78%' }}></div>
                  </div>
                  <span className="text-sm font-medium text-gray-900">78% accuracy in early detection</span>
                </div>
              </div>
              
              <div className="bg-white/60 p-4 rounded-xl">
                <h4 className="font-medium text-gray-900 mb-2">Treatment Outcomes</h4>
                <div className="flex items-center space-x-4">
                  <div className="flex-1 bg-gray-200 rounded-full h-3">
                    <div className="bg-green-600 h-3 rounded-full" style={{ width: '92%' }}></div>
                  </div>
                  <span className="text-sm font-medium text-gray-900">92% positive outcomes</span>
                </div>
              </div>
            </div>
          </div>
      ...
      case 'clinical-reports':
        return (
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl border border-white/20 shadow-2xl p-8 text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-4">Clinical Intelligence Reports</h3>
            <p className="text-gray-600">Advanced clinical analytics coming soon...</p>
          </div>
        );
      case 'population-health':
        return (
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl border border-white/20 shadow-2xl p-8 text-center">
            <UsersIcon className="w-16 h-16 text-orange-600 mx-auto mb-4" />
            <h3 className="text-xl font-bold text-gray-900 mb-4">Population Health Analytics</h3>
            <p className="text-gray-600">Population-wide health insights coming soon...</p>
          </div>
        );
      case 'research-hub':
        return (
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl border border-white/20 shadow-2xl p-8 text-center">
            <FlaskConical className="w-16 h-16 text-indigo-600 mx-auto mb-4" />
            <h3 className="text-xl font-bold text-gray-900 mb-4">Research Analytics Hub</h3>
            <p className="text-gray-600">Research and clinical trial analytics coming soon...</p>
          </div>
        );
      default:
        return renderRealTimeAnalytics();
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <motion.div
          className="absolute -top-40 -right-40 w-80 h-80 bg-gradient-to-r from-purple-400 to-blue-400 rounded-full opacity-20 blur-3xl"
          animate={{
            scale: [1, 1.2, 1],
            rotate: [0, 180, 360],
          }}
        ...
        />
        <motion.div
          className="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-r from-green-400 to-teal-400 rounded-full opacity-20 blur-3xl"
          animate={{
            scale: [1.2, 1, 1.2],
            rotate: [360, 180, 0],
          }}
