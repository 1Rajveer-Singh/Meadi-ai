...
import { 
  ...
  X, Save, User, Heart, Stethoscope, Building, Clock,
  Download, Upload, RefreshCw, Star, Shield, Zap,
  UserPlus, UserX, UserCheck, AlertTriangle, Info
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <motion.div
          ...
          className="bg-white/80 backdrop-blur-xl rounded-3xl border border-white/20 shadow-2xl p-8 mb-8"
        >
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            ...
            <motion.button
              ...
              className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white px-6 py-3 rounded-xl font-medium flex items-center space-x-2 shadow-lg"
            >
          ...
          <div className="flex flex-col lg:flex-row gap-4 mt-8">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none bg-white/70 backdrop-blur-sm"
              />
            </div>
            ...
            <select
              ...
              className="px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none bg-white/70 backdrop-blur-sm"
            >
        ...
        >
          {[
            ...
            { label: 'Active Cases', value: patients.filter(p => p.status === 'active').length, icon: UserCheck, color: 'green' },
            { label: 'High Risk', value: patients.filter(p => p.riskLevel === 'high').length, icon: AlertTriangle, color: 'red' },
            { label: 'New This Week', value: '12', icon: UserPlus, color: 'purple' }
          ].map((stat, index) => {
        ...
        >
          <div className="p-6 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-blue-50">
            ...
            <p className="text-gray-600 text-sm mt-1">Complete patient database with detailed information</p>
          </div>
                ...
                <AnimatePresence>
                  {currentPatients.map((patient, index) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`inline-flex px-3 py-1 text-xs font-semibold rounded-full ${getRiskLevelColor(patient.riskLevel)}`}>
                          {patient.riskLevel}
                        </span>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex space-x-4 pt-6 border-t">
                  ...
                  >
                    ...
                    <span>{showAddModal ? 'Add Patient' : 'Update Patient'}</span>
                  </motion.button>
                  <motion.button
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                ...
                <div className="flex items-center space-x-4 p-6 bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl">
                  ...
                  <div>
                    ...
                    <div className="flex space-x-2 mt-2">
                      <span className={`inline-flex px-3 py-1 text-xs font-semibold rounded-full ${getRiskLevelColor(selectedPatient.riskLevel)}`}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="bg-gray-50 p-4 rounded-xl">
                        <p className="text-sm text-gray-900">{format(selectedPatient.lastVisit, 'MMMM dd, yyyy')}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="bg-gray-50 p-4 rounded-xl">
                        <p className="text-sm text-gray-900">{selectedPatient.notes || 'No notes available'}</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            >
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-6">
                  Are you sure you want to delete <span className="font-medium text-gray-900">{selectedPatient.name}</span>? 
